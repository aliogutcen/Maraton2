...
public class CustomStringTR {
	...
	public void butunKelimeyiCevir() {
		
		System.out.println("Değiştirmek istediğiniz kelimeyi yazınız= ");
		String yeniKelime = scanner.nextLine();
		
		System.out.println("Yeni Kelimeniz =" +this.word.replaceAll(word, yeniKelime));
		
	}
	
	//10.Method
	
	public void bIleBasliyorMu() {
		
		if(this.word.startsWith("b")) {
